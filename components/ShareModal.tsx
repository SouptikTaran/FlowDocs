  ...
  const shareDocumentHandler = async () => {
    ...
    try {
      ...
      await sendInviteEmail({
        to: email,
        documentName: roomId, // Replace with actual document name if available
        inviter: user.info.name || user.info.email,
        documentUrl: `${window.location.origin}/documents/${roomId}`,
      });
      console.log("Sending mail : " , email)
